...
#from roboticstoolbox.tools import trplot
...
T23 = T.subs({d: 0, a: 0.0, alpha: sp.pi})
...
# Para modificar los angulo comodamente
joint1 = np.deg2rad(0)
joint2 = np.deg2rad(0)
...
T04_solved = T04_s.subs({theta_1: joint1, theta_2: joint2, theta_3: joint3, theta_4: joint4})
