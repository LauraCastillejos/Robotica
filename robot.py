...
# =====================================================
# NUEVA TABLA DH (mm -> m)
# i | theta_i (home) | d_i(mm)  | a_i(mm)  | alpha_i(deg)
# 1 | 0°             | 495      | 175      | -90
# 2 | -90°           | 0        | 1095     | 0
# 3 | 0°             | 0        | 175      | -90
# 4 | 0°             | 1230.5   | 0        | 90
...
# De la tabla DH (en metros)
T01 = T.subs({d: 0.495,  a: 0.175,   alpha: -sp.pi/2})
...
T23 = T.subs({d: 0.000,  a: 0.175,   alpha: -sp.pi/2})
T23 = T23.subs(theta, theta_3)
sp.pprint(T23)

T34 = T.subs({d: 1.2305, a: 0.000,   alpha:  sp.pi/2})
...
joint1 = np.deg2rad(0)
joint2 = np.deg2rad(-90)   # tu tabla dice theta2 = -90° en home
joint3 = np.deg2rad(0)
joint4 = np.deg2rad(0)
joint5 = np.deg2rad(0)
joint6 = np.deg2rad(0)
